...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=a3f02c58&
...
// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=a3f02c58&
  ...
  methods: {
    async onCommit() {
      ...
      if (this.article.slug) {
        ...
        const {
          data
        } = await Object(article["k" /* updateArticle */])({
        ...
        const {
          data
        } = await Object(article["j" /* publishArticle */])(this.article);
        this.$router.push({
          name: 'article',
          params: {
            slug: data.article.slug
